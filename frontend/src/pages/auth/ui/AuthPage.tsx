  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" style={{ opacity: op }}>
      <polygon
        ...
        stroke="#C9963A" strokeWidth="1" fill="none"
      />
      <polygon
        points="100,22 112,58 150,58 120,80 132,116 100,95 68,116 80,80 50,58 88,58"
        stroke="#C9963A" strokeWidth="0.7" fill="none"
      />
      <polygon
        points="100,40 108,65 134,65 114,80 122,106 100,91 78,106 86,80 66,65 92,65"
        stroke="#C9963A" strokeWidth="0.5" fill="none"
      />
      <circle cx="100" cy="100" r="6" stroke="#C9963A" strokeWidth="0.7" fill="none" />
      <circle cx="100" cy="100" r="12" stroke="#C9963A" strokeWidth="0.4" fill="none" />
      <circle cx="100" cy="100" r="20" stroke="#C9963A" strokeWidth="0.3" fill="none" />
    </svg>
  )
}
...
function TilePattern() {
  return (
    <svg className="absolute inset-0 w-full h-full pointer-events-none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <pattern id="auth-tile" x="0" y="0" width="88" height="88" patternUnits="userSpaceOnUse">
          <polygon
            points="44,5 53,32 80,32 59,49 67,76 44,59 21,76 29,49 8,32 35,32"
            fill="none" stroke="rgba(201,150,58,0.07)" strokeWidth="0.7"
          />
          <circle cx="44" cy="44" r="5" fill="none" stroke="rgba(201,150,58,0.05)" strokeWidth="0.5" />
          <line x1="44" y1="0" x2="44" y2="88" stroke="rgba(201,150,58,0.02)" strokeWidth="0.4" />
          <line x1="0" y1="44" x2="88" y2="44" stroke="rgba(201,150,58,0.02)" strokeWidth="0.4" />
        </pattern>
      </defs>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full h-11 bg-linear-to-r from-gold to-gold-dark text-navy font-semibold text-[14px] rounded-[8px] tracking-[0.02em] transition-[opacity,transform] duration-150 hover:opacity-90 hover:-translate-y-px disabled:opacity-50 shadow-[0_4px_20px_rgba(201,150,58,0.25)] mt-1"
      >
    ...
    >
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {(
            [
              { value: "PARTICIPANT" as const, label: "Ishtirokchi", desc: "Tadbirlarga qatnashish" },
              { value: "ORGANIZER"   as const, label: "Tashkilotchi", desc: "Tadbirlar yaratish" },
            ]
            ...
            return (
              ...
              >
                <p className={`text-[13px] font-semibold leading-none mb-1 ${active ? "text-gold" : "text-cream/70"}`}>
                  {label}
                </p>
                <p className="text-[11px] text-cream/30 leading-tight">{desc}</p>
              </button>
            )
          })}
        </div>
      ...
      <button
        type="submit"
        disabled={mutation.isPending}
        className="w-full h-11 bg-linear-to-r from-gold to-gold-dark text-navy font-semibold text-[14px] rounded-[8px] tracking-[0.02em] transition-[opacity,transform] duration-150 hover:opacity-90 hover:-translate-y-px disabled:opacity-50 shadow-[0_4px_20px_rgba(201,150,58,0.25)] mt-0.5"
      >
    ...
    <div className="min-h-screen flex bg-navy">
        ...
        <div className="hidden lg:flex lg:w-[46%] relative flex-col justify-between p-12 overflow-hidden bg-navy-dark">
          ...
          <div
            ...
            style={{ background: "linear-gradient(90deg, transparent, rgba(201,150,58,0.38), transparent)" }}
          />
          ...
          <div className="relative z-10 flex flex-col gap-6">
            ...
            >
              ...
              >
                ...
                <em className="lp-serif" style={{ color: "#C9963A", fontStyle: "italic" }}>
                  muammosiz
                </em>
                <br />
                tashkil eting.
              ...
              <p className="text-[14px] text-cream/42 leading-[1.8] max-w-[320px]">
                Maydonlar, xizmatlar, chiptalar — hammasi bir joyda.
                Minglab tashkilotchilarga qo'shiling.
              </p>
            </div>
              ...
              {[
                ...
                >
                  <div
                    ...
                    style={{ fontSize: "26px", fontWeight: 700, color: "#E8C06A" }}
                  >
                    {s.v}
                  </div>
                  <div className="text-[11px] text-cream/38 tracking-wide">{s.l}</div>
                </div>
              ))}
            </div>
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-[11px] text-cream/38 mt-0.5">Yetakchi agentliklar ishonadi</p>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            style={{ background: "linear-gradient(90deg, rgba(201,150,58,0.22), transparent)" }}
          />
        </div>
          ...
          <div className="w-full max-w-[400px]">
            ...
            <div key={`heading-${tab}`} className="mb-7 auth-a auth-d1">
              ...
              <h2
                ...
                style={{ fontSize: "clamp(28px, 5vw, 34px)", fontWeight: 700, color: "#F0E8D4" }}
              >
            ...
            <div className="relative flex border-b border-white/7 mb-7 auth-a auth-d1">
              <button
                ...
                className={`flex-1 pb-3 text-[13px] font-medium transition-colors duration-200 ${
                  tab === "signin" ? "text-cream" : "text-cream/32 hover:text-cream/60"
                }`}
              >
                Kirish
              </button>
              <button
                ...
                className={`flex-1 pb-3 text-[13px] font-medium transition-colors duration-200 ${
                  tab === "register" ? "text-cream" : "text-cream/32 hover:text-cream/60"
                }`}
              >
                Ro'yxatdan o'tish
              </button>
            ...
            <div className="flex items-center gap-3 my-5 auth-a auth-d3">
              ...
              <span className="text-[10px] text-cream/25 tracking-[0.12em] uppercase font-medium">yoki</span>
              <div className="flex-1 h-px bg-white/6" />
            </div>
            ...
            <button
              type="button"
              className="auth-a auth-d3 w-full flex items-center justify-center gap-2.5 h-11 border border-white/8 rounded-[8px] text-[13px] font-medium text-cream/65 hover:text-cream hover:border-white/16 hover:bg-white/3 transition-[color,border-color,background] duration-200"
            >
            ...
            <p className="auth-a auth-d4 text-[11px] text-center text-cream/24 mt-5 leading-[1.7]">
              Davom etish orqali{" "}
              <Link to="/terms" className="text-cream/40 hover:text-gold transition-colors underline underline-offset-2 decoration-cream/20 hover:decoration-gold/50">
                Foydalanish shartlari
              </Link>{" "}
              va{" "}
              <Link to="/privacy" className="text-cream/40 hover:text-gold transition-colors underline underline-offset-2 decoration-cream/20 hover:decoration-gold/50">
                Maxfiylik siyosati
              </Link>
              {" "}bilan rozisiz
            </p>
